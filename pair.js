...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'sigmalordnicks@gmail.com', // Your Mega A/c Email Here
            password: 'wh$Z2JPrMwkrERf' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Merlin-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of MERLIN BOT.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [MERLIN GitHub Repo](https://github.com/sigmalord-nick/)  

🚀 _Thanks for choosing Merlin — Let the automation begin!_ ✨`;
